package com.synergy.quern.compat.jei.categories.core;
...
import com.synergy.quern.api.utils.Image;
...
public abstract class BaseCategory<T> implements IRecipeCategory<T> {
    ...
    protected final Color defaultToolTipColor = new Color(64, 64, 64);
